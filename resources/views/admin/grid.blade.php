                                    ...
                                    <div class="col-md-12 col-lg-12 col-12">
                                        ...
                                        <div class="card-heading">
                                            ...
                                            <div class="col-lg-4 col-md-1 col-sm-2 col-5 text-center" style="padding: 1em 0;
                                                ...
                                                <!--<div class="d-block-xs">.col-xs-5</div>-->
                                            </div>
                                        ...
                                        <!--<div class="row" style="margin-top:10px;">-->
                                            <!--<h3 >xs Grid</h3>-->
                                            <!--<div class="col-5 text-center" style="padding: 1em 0;-->
                                                            <!--background-color: #D9EDF7;-->
                                                            <!--border: 1px solid #A0DEF2;border-radius: 1px;">-->
                                                <!--<div>.col-xs-5</div>-->
                                            <!--</div>-->
                                            <!--<div class="col-4 text-center" style="padding: 1em 0;-->
                                                    <!--background-color: #DFF0D8;-->
                                                    <!--border: 1px solid #A3E69E;border-radius: 1px;">-->
                                                <!--<div>.col-xs-4</div>-->
                                            <!--</div>-->
                                            <!--<div class="col-3 text-center" style="padding: 1em 0;-->
                                                        <!--background-color: #F5DFF7;-->
                                                        <!--border: 1px solid #F0C9F5;border-radius: 1px;">-->
                                                <!--<div>.col-xs-3</div>-->
                                            <!--</div>-->
                                ...
                                <div class="card-body" id="slim2">
                                    <div class="row my-2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-12</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                    <div class="row my-2">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-6</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-center">
                                            <div class="card card-primary">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-lg-4 col-md-4 col-sm-4  text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-4</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4  text-center">
                                            <div class="card card-primary">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-lg-3 col-md-3 col-sm-3  text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-3</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3  text-center">
                                            <div class="card card-primary">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-lg-2 col-md-2 text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-2</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-2 text-center">
                                            <div class="card card-primary">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-lg-1">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-1</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-1">
                                            <div class="card card-primary">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-lg-8 text-center">
                                            <div class="card card-primary">
                                                <div class="card-body body_padding">.col-lg-8</div>
                                            </div>
                                        </div>
