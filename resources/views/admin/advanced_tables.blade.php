...
<section class="content-header">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-lg-12 my-3">
                        <div class="card filterable">
                            <div class="card-heading bg-primary clearfix  ">
                ...
                <div class="row">
                    <div class="col-lg-12 my-3">
                        <div class="card filterable">
                            <div class="card-heading clearfix bg-info">
                ...
                <div class="row">
                    <div class="col-lg-12 my-3">
                        <div class="card filterable">
                            <div class="card-heading bg-warning clearfix">
                                <h3 class="card-title float-left">
                                     <i class="livicon" data-name="gift" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                   Scroller
                                </h3>
                ...
                <div class="row">
                    <div class="col-lg-12 my-3">
                        <div class="card filterable table-tools">
                            <div class="card-heading clearfix bg-primary ">
                                <div class="card-title float-left">
                                    <div class="caption">
