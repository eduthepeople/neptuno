            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-12 my-3">
                        ...
                        <div class="card my-3">
                            <div class="card-heading bg-default text-white">
                            ...
                            <div class="card-body">
                                <div  id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="card ">
                                        <div class="card-heading bg-default text-white" role="tab" id="headingOne">
                                            <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                <h4 class="card-title color1_accordians text-white">Accordion1</h4>
                                            </a>
                                        </div>
                                    ...
                                    <div class="card  my-3">
                                        <div class="card-heading bg-default text-white" role="tab" id="headingTwo">
                                            <a data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                <h4 class="card-title color1_accordians text-white">
                                                    Accordion2
                                                </h4>
                                            </a>
                                        </div>
                                    ...
                                    <div class="card  my-3">
                                        <div class="card-heading bg-default text-white" role="tab" id="headingThree">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                <h4 class="card-title color1_accordians text-white"> Accordion3</h4>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-content faq-cat-content">
                                    <div class="tab-pane  show active in fade" id="faq-cat-1">
                                        <div  id="accordion-cat-1">
                                            <div class="card card-faq my-3">
                                                <div class="card-heading bg-default text-white" id="headingOne">
                                            ...
                                            <div class="card card-faq">
                                                <div class="card-heading bg-default text-white" id="headingThree">
                                    ...
                                    <div class="tab-pane fade" id="faq-cat-2">
                                        <div id="accordion-cat-2">
                                            ...
                                            <div class="card card-faq">
                                                <div class="card-heading bg-default text-white" id="headingTwo">
