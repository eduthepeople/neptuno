    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-success">
                        <h3 class="card-title">
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="eye-open" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i> Outline Buttons
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="eye-open" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i>Circle buttons
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i>Block level Button
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="location" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i> Pill Buttons
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i> Button Wrapper
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    <div class="card-heading card-outline-info">
                        <h3 class="card-title">
                            <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i>Button Group2
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6 col-12 ">
                <div class="card">
                    <div class="card-heading card-outline-info ">
                        <h3 class="card-title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i>Social Dashboard
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
        ...
        <div class="row mb-4">
            <div class=" col-12 ">
                <div class="card">
                    <div class="card-heading  card-outline-info ">
                        <h3 class="card-title">
                            <i class="livicon" data-name="check" data-size="16" data-loop="true" data-c="#418bca"
                               data-hc="#418bca"></i> Social Buttons
                        </h3>
                        <span class="float-right ">
                                    <i class="fa fa-chevron-up clickable"></i>
                                </span>
